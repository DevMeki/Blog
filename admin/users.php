        ...
        <main class="p-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-slate-500 font-mono">@admin</div>
                                </td>
                                <td class="px-6 py-4 text-slate-600">
                                    admin@midnightblog.com
                                </td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1 bg-primary text-white rounded-lg text-xs font-bold shadow-sm shadow-primary/30">Administrator</span>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="font-bold text-slate-800">John Smith</div>
                                    <div class="text-xs text-slate-500 font-mono">@jsmith</div>
                                </td>
                                <td class="px-6 py-4 text-slate-600">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold">Subscriber</span>
                                </td>
                                <td class="px-6 py-4 text-slate-500">
                                    Oct 15, 2023
                                </td>
                ...
                <div class="px-6 py-4 border-t border-slate-100 flex items-center justify-between">
                    <span class="text-sm text-slate-500">Showing 1 to 2 of 2 users</span>
